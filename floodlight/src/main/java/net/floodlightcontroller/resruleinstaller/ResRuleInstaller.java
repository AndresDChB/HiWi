...
public class ResRuleInstaller implements IOFMessageListener, IFloodlightModule, IOFSwitchListener {
    ...
    private static final String dataRate = "8000"; //Mbps
    ...
    public net.floodlightcontroller.core.IListener.Command receive(IOFSwitch sw, OFMessage msg, FloodlightContext cntx) {
        ...
        if (flowsSent) {
            ...
            try {
                CSVWriter.writeToCsv("/home/borja/HiWi/floodlight/results/with_traffic/8G/installation_latency.csv", newData, write);
            }
            catch (IOException e) {
        ...
        if (deleteMsgSent) {
            ...
            try {
                CSVWriter.writeToCsv("/home/borja/HiWi/floodlight/results/with_traffic/8G/deletion_latency.csv", newData, write);
            }
            catch (IOException e) {
                logger.info("CSV Writer fn exploded lfmao");
            }
    ...
    private void drillDownTest(DatapathId switchId) {
        ...
        for (int i = 0; i < measurements; i++) {
                ...
                if (!drillDownEnded) {
                    ...
                    if (poller.pollin(0)) {
                        ...
                        if (message != null) {
                            ...
                            try {
                                CSVWriter.writeToCsv("/home/borja/HiWi/floodlight/results/with_traffic/8G/dd_iteration.latency.csv", newData, write);
                            } catch (IOException e) {
                                logger.info("CSV Writer fn exploded lfmao\n" + e);
                            }
            ...
            try {
                CSVWriter.writeToCsv("/home/borja/HiWi/floodlight/results/with_traffic/8G/dd_latency_with_classififcation.csv", newData, write);
            }
            catch (IOException e) {
